...
`
    ...
    links.forEach((link: TODO) => {
      const siteUrl = process.env.VERCEL_PREVIEW_URL || "https://docs.radas.com"
...
async function brokenLinkChecker(): Promise<void> {
  ...
  const options = {
    ...
    excludedKeywords: ["gitlab.com/-", "platform.openai.com", "https://github.com/radasapp/radas-docs/blob/main/content/docs", "Edit on GitHub"],
