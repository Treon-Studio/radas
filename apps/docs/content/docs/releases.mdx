...
radas is released on a regular basis in two separate tracks. Their version numbers are incremented independently.
...
<Callout type="info">
You can find the download links and changelogs for the latest releases on our [GitHub Releases](https://github.com/radasapp/radas/releases).
</Callout>

## Platforms

We bundle and ship radas for Mac OS, Windows, and Linux.
