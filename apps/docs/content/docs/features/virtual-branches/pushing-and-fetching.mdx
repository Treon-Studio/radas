...
radas can authenticate with an upstream Git server in several different ways.
...
Once that's done, radas will be able to automatically fetch upstream work and push new branches to your upstream server.
