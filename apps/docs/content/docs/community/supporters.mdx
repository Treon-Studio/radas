...
No worries, the main stuff in radas stays the same whether you pay or not.
...
Your support helps us grow and make radas even better. Join us on this adventure!

## How to Support Us
You need to have a radas account to support us. If you don't have one, sign up first.
...
<Cards>
  <Card
    ...
    href="https://app.radas.com/supporter"
    title="radas"
    description="Support radas with a monthly contribution"
  />
</Cards>

Thanks, from the radas Crew!
