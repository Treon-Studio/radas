...
import { useStore, type Agent, type QueuedMessage, type StationKind, type ToolKind } from '@office/store/store';
import {
  buildSpawnCommand,
  ASSISTANT_MODEL,
  inferAgentProvider,
...
import { acquireTerminal, resetTerminal, isTerminalAutomationSafe } from '@office/components/terminalPool';
import { canDeliverToAgent, deliverWithAcknowledgement, checkPrecondition } from './queueDelivery';
import { OFFICE_CAST, DEFAULT_CHARACTER } from '@office/scene/office/cast';
