...
import { useStore, selectedAgent } from '@office/store/store';
import { startMockLoop, stopMockLoop } from '@office/store/mockEvents';
import type { HarnessConfig } from '@office/store/config';
import { DEFAULT_ORG_TRIGGER } from '@shared/triggers';
import { OfficeFloor } from '@office/scene/office/OfficeFloor';
import { useHive } from '@office/hooks/useHive';
import { useResolvedGodName } from '@office/hooks/useResolvedGodName';
import { useGodNameSync } from '@office/i18n/useGodNameSync';
import { useDirectionSync } from '@office/i18n/useDirection';
import { useArabicTerminalSync } from '@office/terminal/useArabicTerminalSync';
import { MemoryPanel } from '@office/components/MemoryPanel';
import { AgentDetailPanel } from '@office/components/AgentDetailPanel';
import { AgentStrip } from '@office/components/AgentStrip';
import { AddAgentModal } from '@office/components/AddAgentModal';
import { MichaelBooting } from '@office/components/MichaelBooting';
import { OnboardingWizard } from '@office/components/OnboardingWizard';
import { HivePicker } from '@office/components/HivePicker';
import { QuitWarningModal, type ClosingTimeState } from '@office/components/QuitWarningModal';
import { CompletionToast } from '@office/realtime/CompletionToast';
import { UpdateToast } from '@office/components/UpdateToast';
import { UpdateBadge } from '@office/components/UpdateBadge';
import { useAppTheme, toggleAppTheme } from '@office/design/theme';
import { SettingsModal, type Section as SettingsSection } from '@office/components/SettingsModal';
import { PixelPanel } from '@office/components/PixelPanel';
import { PixelButton } from '@office/components/PixelButton';
import { Icon } from '@office/components/Icon';
import { SidebarSplitter } from '@office/components/SidebarSplitter';
import { acquireTerminal, notifyThemeChangeAll } from '@office/components/terminalPool';
import { FullscreenTerminal } from '@office/components/FullscreenTerminal';
import { TaskDetailOverlay } from '@office/components/TaskDetailOverlay';
import { IdePanel } from '@office/ide/IdePanel';
import { useHoldOptionToTalk } from '@office/freeflow/holdOption';
