// @ts-nocheck — vendored from munder-difflin (chaitanyagiri/munder-difflin), not written for this tsconfig's strictness
import { useEffect, useRef, useState } from 'react';
import { useTranslation } from './i18nStub';
...
import { useStore, type Agent } from './officeStore';
